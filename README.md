...
- 개발용 실행본: `dist-dev-2.0.3`
- 배포용 실행본: `dist-release-2.0.3`
...
```powershell
.\dist-release-2.0.3\Aion2Dashboard.exe
```

또는 개발용:

```powershell
.\dist-dev-2.0.3\Aion2Dashboard.exe
```

## 빌드

```powershell
dotnet publish .\Aion2Dashboard\Aion2Dashboard.csproj -c Release -o .\dist-dev-2.0.3
dotnet publish .\Aion2Dashboard\Aion2Dashboard.csproj -c Release -o .\dist-release-2.0.3 -p:DefineConstants=DISTRIBUTION
```
...
- 배포용 zip: `DPSVIEWER-release-2.0.3.zip`
- 개발용 zip: `DPSVIEWER-dev-2.0.3.zip`
